            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder('1')">
                  <a>综合<span v-show="isOne" class="iconfont" :class="{'icon-cs-jt-xx-1-1':isDesc,'icon-cs-jt-xs-1-1':isAsc}"></span></a>
                </li>
                <li :class="{active:isTwo}" @click="changeOrder('2')">
                  <a>价格<span v-show="isTwo" class="iconfont" :class="{'icon-cs-jt-xx-1-1':isDesc,'icon-cs-jt-xs-1-1':isAsc}"></span></a>
                </li>
              </ul>
            </div>
          </div>
...
export default {
  ...
  computed: {
    //mapGetters里面的写法：传递的数组，因为getters计算是没有划分模块的【模块指的是home、search】
